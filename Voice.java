...
/*
 * Class that creates a JFrame window for the Voice Commands tutorial.
 */
public class Voice {
	...
	private String p1 = "<b>Voice Commands</b><br>"
			+ " <br>"
			+ "- If you do not wish to spend excess time, you can utilise the voice command, which is automatically activated upon the startup of your computer.<br>"
			+ " <br>"
			+ "- Simply speak a command (e.g. “open browser”, “shut down”, or “search Mass Academy”), and the computer will follow and execute it.<br>";

	/*
	 * Opens the Voice Commands tutorial window/runs the code.
	 */
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new Voice().createUI());
	}
	...
	private void createUI() {
		...
		contentPanel.add(createImage("/Images/VCS.png", 800));
