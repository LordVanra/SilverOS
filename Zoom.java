...
/*
 * Class that creates a JFrame window for the Zoom tutorial.
 */
public class Zoom {
	...
	private String p1 = "<b>Zoom Help</b><br>"
			+ "<br>"
			+ "<b>How to set up Zoom and operate it:</b><br>"
			+ "<br>"
			+ "- Click on Zoom to start the application.<br>"
			+ "<br>"
			+ "- If you would like to create your own meeting for others to join, click on the orange “New Meeting” button with your cursor.<br>"
			+ "<br>"
			+ "- If you would like to join a meeting hosted by someone else, click on the “Join” button with your cursor.<br>"
			+ "<br>"
			+ "   * It will prompt you to enter a meeting ID and perhaps a password as well. This information should be provided to you by the person running the online meeting.*";

	private String p2 = "You may choose to join the meeting with your camera and audio on/off (other members will be able to see you and hear you if you choose to join with these on). You may change either of these preferences after joining the meeting as well, if at any point you do not wish to be seen or heard by others.";

	/*
	 * Opens the Zoom tutorial window/runs the code.
	 */
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new Zoom().createUI());
	}
	...
	private void createUI() {
		JFrame frame = new JFrame("Zoom Help");
		...
		contentPanel.add(createImage("/Images/ZoomHome.png", 350));
		...
		contentPanel.add(createImage("/Images/ZoomJoin.png", 500));
